...
/* ─── ICONOS SVG (inline) ─────────────────────────────────── */
const ICONS = {
  linux: `<img src="assets/icons/linux-tux-1-logo-png-transparent.png" alt="Linux">`,
  ...
  nmap: `<img src="assets/icons/nmap.png" alt="Nmap">`,  
  ...
  siem: `<img src="assets/icons/Wazuh-orig.png" alt="Wazuh">`,
  ...
  iam: `<img src="assets/icons/aws-iam-logo-icon-png-svg.png" alt="AWS IAM">`,
  ...
  kali: `<img src="assets/icons/kali-linux.png" alt="Kali Linux">`,
  ...
  checkov: `<img src="assets/icons/checkov_blue_logo.png" alt="Checkov">`,
};
...
const SKILL_CATEGORIES = [
  ...
  { label: 'Ofensiva & Análisis de Vulnerabilidades', items: [
    { name: 'Nmap',       icon: 'nmap' },
