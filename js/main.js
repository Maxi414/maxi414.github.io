...
const SKILL_CATEGORIES = [
  ...
  { label: 'Nube', items: [
    { name: 'AWS',       level: 'Intermediate', lvlClass: 'lvl-intermediate', icon: 'aws' },
    { name: 'AWS IAM',   level: 'Intermediate', lvlClass: 'lvl-intermediate', icon: 'iam' },
    { name: 'Terraform', level: 'Intermediate', lvlClass: 'lvl-intermediate', icon: 'terraform' },
  ]},
  { label: 'Desarrollo, Scripting & Datos', items: [
    ...
    { name: 'Git',    level: 'Intermediate', lvlClass: 'lvl-intermediate', icon: 'git' },
